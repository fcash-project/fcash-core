...
"""Verify that starting fcash with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start fcash with -h for help text")
        ...
        self.log.info("Start fcash with -version for version information")
