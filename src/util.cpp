...
const char * const BITCOIN_CONF_FILENAME = "fcash.conf";
const char * const BITCOIN_PID_FILENAME = "fcashd.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Fcash";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Fcash";
#else
    // Unix
    return pathRet / ".fcash";
#endif
#endif
}
