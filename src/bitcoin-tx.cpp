...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s fcash-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  fcash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded fcash transaction") + "\n" +
              "  fcash-tx [options] -create [commands]   " + _("Create hex-encoded fcash transaction") + "\n" +
              "\n";
